...
_TIPS = {
    'en': [
        ...
        "Tip: /update semantically merges official updates, mirrors myfork, and reports an update ledger.",
...
_I18N: dict[str, dict[str, str]] = {
    'en': {
        ...
        'help.update':          '  /update [note]       LLM-merge official updates, mirror myfork, report ledger',
        ...
        'cmd.update.arg':       '[note]',
        'cmd.update.desc':      'LLM-merge official updates, mirror myfork, report update ledger',
    ...
    'zh': {
        ...
        'help.update':          '  /update [备注]       LLM 语义合并官方更新、同步 myfork、生成更新账单',
        ...
        'cmd.language.arg':     '[code]',
        'cmd.update.arg':       '[备注]',
        'cmd.update.desc':      'LLM 语义合并官方更新、同步 myfork、生成更新账单',
        'cmd.autorun.arg':      '[seed]',
