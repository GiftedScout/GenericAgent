(() => {
  ...
  zh: {
    ...
    'presetPrompt.plan': '进入规划状态：根据下一任务匹配现行 SOP，先核实现状、约束与验收标准，再给出可执行计划；不要修改环境，等我确认后实施。',
  ...
  en: {
    ...
    'presetPrompt.plan': 'Enter planning state for my next task: match current SOPs, verify the situation, constraints, and acceptance criteria, then propose an actionable plan. Do not modify the environment until I confirm.',
